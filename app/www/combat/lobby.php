...
<body>
  ...
  <main class="page projects-page">
    <section class="portfolio-block projects-cards">
      <div class="container" id="selection">
        <div class="heading">
          <h2>Choisir un dresseur pour combattre</h2>
        </div>
        <div class="row">
          <?php
          ...
          foreach ($dresseursReply as $dresseur) {
            ...
            print_r("<div class='col-md-6 col-lg-4'>
                                 <div class='carddresseurs border-0'><a class='function' onclick=\"selectDresseur(this)\" id=\"$dresseurId\"><img src='$root$dresseurImage' alt='Image de $dresseurNom' class='dresseursimage card-img-top dresseursimage scale-on-hover'></a>
                                   <div class='card-body'>
                                     <h6><a class='function' onclick=\"selectDresseur(this)\" id=\"$dresseurId\">$dresseurNom</a></h6>
  ...
  <script src="<?= $root?>assets/js/combat/lobby.js"></script>
</body>
